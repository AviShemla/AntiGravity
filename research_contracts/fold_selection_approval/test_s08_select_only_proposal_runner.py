...
from research_contracts.fold_selection_approval import s08_select_only_proposal_runner as runner
...
def assembly(*, fresh=True, execution=False):
    ...
    return SimpleNamespace(
        ...
        panel_sha256="6" * 64, panel_shape=(474, 416),
...
class RunnerTests(unittest.TestCase):
    def call(self, result=None):
        ...
        with patch.object(runner, "_effective_uid", return_value=0), \
             ...
             patch.object(runner, "assemble_v5_proposal", return_value=result), \
