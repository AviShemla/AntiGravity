...
if __name__ == '__main__':
    ...
    # Target is EBAY raw returns
    target_returns = return_pivot[champion_ticker].rename(f'{champion_ticker}_Target')
    
    for l in [1, 2, 3]:
        res = run_pymc_experiment(target_returns, all_predictors_df, l, "EBAY Advanced Features")
        results.append(res)
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'PyMC_EBAY_Advanced_Results.csv')
