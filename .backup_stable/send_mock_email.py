...
export_dir = BASE_DIR
scorecard_path = os.path.join(BASE_DIR, 'financial_data', 'Top5_Bayesian_Scorecard.csv')
...
<p>Good morning,</p>
<p>The automated AntiGravity pipeline has successfully finished running for today. (THIS IS A TEST RENDER)</p>
...
<hr>
<p style="color: gray; font-size: 12px;">System: All systems nominal. (TEST RENDERING)</p>
</body>
</html>
"""
...
try:
    ...
    mail.Subject = "AntiGravity Virtual Broker: TEST RENDER"
