...
def get_losing_trades(persona, mode):
    ...
    if mode == "Single":
        ...
        ledger_path = os.path.join(BASE_DIR, f'ETF_Capital_Ledger_{persona}.csv')
...
tab1, tab2, tab3, tab4 = st.tabs(["🏛️ Single Stocks", "🪐 ETF Markets", "🏆 Bayesian Olympics", "☠️ Trade Autopsy"])
