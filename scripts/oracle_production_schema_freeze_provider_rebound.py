...
from corrected_freeze_manifest import (
    build_corrected_freeze_manifest,
...
ENVELOPE_SHA256 = "456179cd172ce882f304b461d47f3e24d91e94b180d5dbf29e853f0d1f70480e"
SCHEMA_SHA256 = "d21aa91b356666c6509e234a74f3041130fc1e4ae62455086aa86b2b18e6e01e"
FREEZE_MANIFEST_SHA256 = "d5f6c520d3bd5db1c4927133037a80611f18baabdc46b011a96d85ae79604c57"
...
PROVIDER_SHA256 = "d0ae4b277bd63f8668fdb6898961bbb0b46f153c35fcb6bc15e8d1d616c23a1d"
...
def _authorization_material(root: Path, authorization_path: Path):
    ...
    contract_path = root / "governance/corrected_application_contract_v2.json"
...
def freeze_dataset(root: Path, reader, session, endpoint: str, token: str, authorization_path: Path, *, actor: str) -> dict:
    ...
    manifest = build_corrected_freeze_manifest(
        verified_freeze_manifest_inputs(),
