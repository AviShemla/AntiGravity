        ...
        try {
            ...
            if (raceRes.ok) {
                ...
                const raceLayout = Object.assign({}, STD_LAYOUT, {
                    xaxis: { type: 'category', tickformat: "%d/%m/%Y", tickmode: "linear", dtick: 86400000, tickangle: -45, color: 'white', gridcolor: 'rgba(255,255,255,0.1)', rangeslider: { visible: true, thickness: 0.08, bgcolor: '#383838', bordercolor: '#1E90FF', borderwidth: 1 } },
                    yaxis: { color: 'white', gridcolor: 'rgba(255,255,255,0.1)' }
                });
...
function plotNormalDist(mu, sigma, targetDiv) {
    ...
    Plotly.newPlot(targetDiv, [traceLoss, traceWin], Object.assign({}, STD_LAYOUT, {
        ...
        xaxis: { type: 'category', tickformat: "%d/%m/%Y", tickmode: "linear", dtick: 86400000, tickangle: -45, color: 'white', gridcolor: 'rgba(255,255,255,0.1)' },
        yaxis: { color: 'white', gridcolor: 'rgba(255,255,255,0.1)' }
    }));
}
